...
async def start(event):
  await event.reply("Hey [🤗](https://te.legra.ph/file/8d6307fcac08120cb9380.jpg), Welcome,😎 I m Highly advanced Tag Member Bot\n🔥I can tag  members in group as well as in Channel.\n💡Need Help /help\n\n🔥🥂ᴩᴏᴡᴇʀᴇᴅ ʙy: @attitude_galaxy",
                    buttons=(
                      [Button.url('🔥ᴀᴅᴅ ᴛᴀɢ ᴍᴇᴍʙᴇʀ ᴛᴏ ɢʀᴏᴜᴩ🔥', 'http://t.me/Tag_member_robot?startgroup=true')],
                      [Button.url('⚜ᴏᴡɴᴇʀ⚜', 'Https://t.me/Deewana_mahadev_ka')],
                      [Button.url('🛎ꜱᴜᴩᴩᴏʀᴛ', 'https://t.me/thunder_buddy_group'),
                      Button.url('ᴜᴩᴅᴀᴛᴇ🔊', 'https://t.me/ek_2je_ke_vastee')]
                     ),
                    link_preview=False
                   )
...
print("~~~~Started~~~~~")
print("🔥🥂Need Help Dm @Deewana_mahadev_ka")
client.run_until_disconnected()
#Copyright @Deewana_mahadev_ka
#sys
import os, logging, asyncio
...
async def start(event):
  await event.reply("Hey [🤗](https://te.legra.ph/file/8d6307fcac08120cb9380.jpg), Welcome,😎 I m Highly advanced Tag Member Bot\n🔥I can tag  members in group as well as in Channel.\n💡Need Help /help\n\n🔥🥂ᴩᴏᴡᴇʀᴇᴅ ʙy: @attitude_galaxy",
                    buttons=(
                      [Button.url('🔥ᴀᴅᴅ ᴛᴀɢ ᴍᴇᴍʙᴇʀ ᴛᴏ ɢʀᴏᴜᴩ🔥', 'http://t.me/Tag_member_robot
?startgroup=true')],
                      [Button.url('⚜ᴏᴡɴᴇʀ⚜', 'Https://t.me/Deewana_mahadev_ka')],
                      [Button.url('🛎ꜱᴜᴩᴩᴏʀᴛ', 'https://t.me/thunder_buddy_group'),
                      Button.url('ᴜᴩᴅᴀᴛᴇ🔊', 'https://t.me/ek_2je_ke_vastee
